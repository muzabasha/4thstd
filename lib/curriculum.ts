...
const evsSubject: Subject = {
  ...
  chapters: [
    ...
    { id: 'e11', title: '11. The Valley of Flowers', topics: [{ id: 'e11-t1', title: 'Plants', subtopics: ['Uttarakhand flora'], readingText: { en: 'Uttarakhand has the Valley of Flowers.' }, activities: [act('The Natural Dye Maker', 'Extract colors from flower petals to make organic art.', 'performing', 'mid', ['Collect fallen petals (Red, Yellow, Blue)', 'Crush them with a little water', 'Use the juice as paint', 'Draw a flower with its own colors'], ['Petals', 'Bowl', 'Paper'], 'Which flower gave the strongest color?')], quiz: [q('Where is Valley of Flowers?', ['Bihar', 'Uttarakhand'], 'Uttarakhand')], learningOutcomes: ['Identify local plants'] }] },
    { id: 'e12', title: '12. Changing Times', topics: [{ id: 'e12-t1', title: 'Houses', subtopics: ['Materials'], readingText: { en: 'Houses changed from mud to cement.' }, activities: [act('Mini Mud-House Builder', 'Build a small model of a traditional house using clay or mud.', 'performing', 'high', ['Mix clay with water', 'Build 4 small walls', 'Add a "thatch" roof with dry grass', 'Let it dry and test its strength'], ['Clay/Mud', 'Dry grass', 'Sticks'], 'How is this different from a cement house?')], quiz: [q('Old houses used?', ['Steel', 'Mud'], 'Mud')], learningOutcomes: ['Identify housing changes'] }] },
    { id: 'e13', title: '13. A River\'s Tale', topics: [{ id: 'e13-t1', title: 'Rivers', subtopics: ['Pollution'], readingText: { en: 'Factories pollute rivers.' }, activities: [act('The River Pollution Simulator', 'Observe how pollutants spread in a bowl of clean water.', 'performing', 'mid', ['Fill a clear bowl with water', 'Add 1 drop of ink (pollution)', 'Observe how it spreads', 'Try to "clean" it with a spoon'], ['Clear bowl', 'Ink or Oil', 'Water'], 'Can you easily remove the ink once it spreads?')], quiz: [q('Where do rivers start?', ['Sea', 'Mountains'], 'Mountains')], learningOutcomes: ['Understand conservation'] }] },
    { id: 'e14', title: '14. Basva\'s Farm', topics: [{ id: 'e14-t1', title: 'Farming', subtopics: ['Onions', 'Tools'], readingText: { en: 'Basva is from Karnataka. They grow onions.' }, activities: [act('The Kitchen Onion Farmer', 'Plant an onion in a pot and track its growth.', 'performing', 'mid', ['Take a small pot with soil', 'Press a small onion halfway in', 'Water it every morning', 'Measure the green shoots daily'], ['Onion', 'Pot', 'Soil'], 'How many days did it take to sprout?')], quiz: [q('Basva is from?', ['Goa', 'Karnataka'], 'Karnataka')], learningOutcomes: ['Learn farming steps'] }] },
...
const hindiSubject: Subject = {
  ...
  chapters: [
    { id: 'h1', title: '1. मन के भोले-भाले बादल', topics: [{ id: 'h1-t1', title: 'कविता', subtopics: ['बादल'], readingText: { en: 'Poem about clouds.', hi: 'बादल भोले-भाले बच्चों की तरह हैं।' }, activities: [act('बादल कोलाज', 'रुई और कागज़ की मदद से बादलों के अलग-अलग आकार बनाओ।', 'drawing', 'low', ['रुई लें', 'नीले कागज़ पर चिपकाएँ', 'हाथी या ऊँट का आकार दें', 'बादलों के नाम लिखें'], ['Cotton', 'Blue paper', 'Glue'], 'आपका बादल कौन सा जानवर लग रहा है?')], quiz: [q('बादल कैसे हैं?', ['भोले-भाले', 'कठोर'], 'भोले-भाले')], learningOutcomes: ['कविता का आनंद'] }] },
    ...
    { id: 'h3', title: '3. किरमिच की गेंद', topics: [{ id: 'h3-t1', title: 'ईमानदारी', subtopics: ['सच्चाई'], readingText: { en: 'Honesty story.', hi: 'दिनेश को एक गेंद मिली।' }, activities: [act('खोया-पाया रिपोर्ट', 'एक गेंद मिलने की सूचना बनाओ ताकि असली मालिक मिल सके।', 'writing', 'mid', ['गेंद का रंग लिखें', 'कहाँ मिली लिखें', 'अपना नाम लिखें', 'सूचना बोर्ड पर लगाएँ'], ['Notebook', 'Pen'], 'क्या आपने गेंद के मालिक को ढूँढा?')], quiz: [q('क्या मिली?', ['गेंद', 'बल्ला'], 'गेंद')], learningOutcomes: ['नैतिकता'] }] },
...
const kannadaSubject: Subject = {
  ...
  chapters: [
    { id: 'k1', title: '1. ಕನ್ನಡ ನಾಡು ನುಡಿ', topics: [{ id: 'k1-t1', title: 'ಕರ್ನಾಟಕ', subtopics: ['ನಾಡಗೀತೆ'], readingText: { en: 'Karnataka culture.', kn: 'ಕರ್ನಾಟಕದ ಸಂಸ್ಕೃತಿ ಮತ್ತು ನಾಡಗೀತೆ.' }, activities: [act('ನಮ್ಮ ಭೂಪಟ', 'ಕರ್ನಾಟಕದ ಭೂಪಟವನ್ನು ಬಿಡಿಸಿ ಮತ್ತು ಜಿಲ್ಲೆಗಳನ್ನು ಗುರುತಿಸಿ.', 'drawing', 'mid', ['ಭೂಪಟ ಬಿಡಿಸಿ', 'ಬೆಂಗಳೂರು ಗುರುತಿಸಿ', 'ಜಿಲ್ಲೆಗಳಿಗೆ ಬಣ್ಣ ಹಾಕಿ', 'ಮುಖ್ಯ ನದಿಗಳನ್ನು ಹೆಸರಿಸಿ'], ['Map paper', 'Crayons'], 'ನಿಮ್ಮ ಜಿಲ್ಲೆ ಯಾವುದು?')], quiz: [q('ರಾಜಧಾನಿ ಯಾವುದು?', ['ಮೈಸೂರು', 'ಬೆಂಗಳೂರು'], 'ಬೆಂಗಳೂರು')], learningOutcomes: ['ಸಾಂಸ್ಕೃತಿಕ ಅರಿವು'] }] },
...
const computerSubject: Subject = {
  ...
  chapters: [
    { id: 'c1', title: '1. Know Your Computer', topics: [{ id: 'c1-t1', title: 'Basics', subtopics: ['Hardware', 'Software'], readingText: { en: 'Computers are machines that help us work.' }, activities: [act('Input/Output Sorting', 'Sort household items into Input (giving info) or Output (showing info).', 'performing', 'mid', ['Collect 5 items (Keyboard, Speaker, Mouse, Screen, Mic)', 'Place them in 2 boxes: Input & Output', 'Explain why for each', 'Draw them in your book'], ['5 Household items'], 'Is a printer Input or Output?')], quiz: [q('Is brain like a CPU?', ['Yes', 'No'], 'Yes')], learningOutcomes: ['Define computer parts'] }] },
    { id: 'c2', title: '2. Input and Output', topics: [{ id: 'c2-t1', title: 'Devices', subtopics: ['Mouse', 'Printer'], readingText: { en: 'Input devices give data, Output devices show results.' }, activities: [act('Cardboard PC Builder', 'Create a 3D model of a computer using cardboard boxes.', 'drawing', 'high', ['Find 4 boxes', 'Label them: CPU, Monitor, Keyboard, Mouse', 'Connect them with string "wires"', 'Explain the role of each "part"'], ['Cardboard', 'String', 'Markers'], 'Which part is the brain?')], quiz: [q('Which part is the brain?', ['Monitor', 'CPU'], 'CPU')], learningOutcomes: ['Identify parts'] }] },
    ...
    { id: 'c4', title: '4. MS Word Intro', topics: [{ id: 'c4-t1', title: 'Typing', subtopics: ['Font', 'Save'], readingText: { en: 'MS Word is for typing letters.' }, activities: [act('The Digital Journalist', 'Type a 3-line news story about your day and format it.', 'performing', 'high', ['Type a headline in BOLD', 'Write 2 lines of text', 'Change the font color to Blue', 'Save the file as "MyNews"'], ['PC'], 'What was your headline?')], quiz: [q('Used for typing?', ['Paint', 'Word'], 'Word')], learningOutcomes: ['Basic typing'] }] },
    { id: 'c5', title: '5. Internet Safety', topics: [{ id: 'c5-t1', title: 'Online Rules', subtopics: ['Privacy'], readingText: { en: 'Don\'t share passwords online.' }, activities: [act('The Password Shield', 'Design a secret "Symbol Key" to remember your password.', 'writing', 'mid', ['Pick 3 symbols (*, &, #)', 'Combine them with a favorite color', 'Draw your "Shield"', 'Never share it!'], ['Notebook'], 'Is your password strong?')], quiz: [q('Share password?', ['Yes', 'No'], 'No')], learningOutcomes: ['Digital citizenship'] }] },
